...
class ViewManager {
    ...
    public updateAndDisplay() {
        ...
        this.updateAndDisplayWithUrl(url);
    }
    ...
    public displayWithUrl(url: string) {
        ...
        try {
            ...
            this.displayContentOfPage(newPage);
        } catch (error) {
    ...
    public async displayContentOfPage(page: WebPage): Promise<void> {
        ...
        try {
            ...
            await page.load();
            let doc = page.getFrame().getDocument();
    ...
    public async displayContentOfFrame(frame: FrameData): Promise<void> {
        ...
        this.ui.contentFrame.src = frame.getUrl();
